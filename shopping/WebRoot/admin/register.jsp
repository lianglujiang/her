  ...
  <body>
    <form action="saveUser.action">
		...
		<tr>
			...
			请再输一遍确认</td>
			<td class="tablebody1">
			<input type="password" maxLength="8" size="32" name="user.password2" style="font-family: Tahoma,Verdana,宋体; font-size: 12px; line-height: 15px; color: #000000">
			<font color="#FF0000">*</font></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td class="tablebody1">
			<input type="text" size="64" maxlength="32" name="user.address" style="font-family: Tahoma,Verdana,宋体; font-size: 12px; line-height: 15px; color: #000000">
			</td>
		</tr>
